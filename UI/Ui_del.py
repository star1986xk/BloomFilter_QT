...
# Form implementation generated from reading ui file 'Ui_del.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_true_count = QtWidgets.QLabel(self.widget_5)
        self.label_true_count.setObjectName("label_true_count")
        self.horizontalLayout_4.addWidget(self.label_true_count)
        self.label_4 = QtWidgets.QLabel(self.widget_5)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_4.addWidget(self.label_4)
        self.label_false_count = QtWidgets.QLabel(self.widget_5)
        self.label_false_count.setObjectName("label_false_count")
        self.horizontalLayout_4.addWidget(self.label_false_count)
        self.label_3 = QtWidgets.QLabel(self.widget_5)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_4.addWidget(self.label_3)
        self.label_true_count_2 = QtWidgets.QLabel(self.widget_5)
        self.label_true_count_2.setObjectName("label_true_count_2")
        self.horizontalLayout_4.addWidget(self.label_true_count_2)
        self.label_5 = QtWidgets.QLabel(self.widget_5)
        self.label_5.setObjectName("label_5")
        self.horizontalLayout_4.addWidget(self.label_5)
        self.label_false_count_2 = QtWidgets.QLabel(self.widget_5)
        self.label_false_count_2.setObjectName("label_false_count_2")
        self.horizontalLayout_4.addWidget(self.label_false_count_2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_many.setText(_translate("Dialog", "删除多条"))
        self.label.setText(_translate("Dialog", "数据"))
        self.pushButton_one.setText(_translate("Dialog", "删除一条"))
        self.label_2.setText(_translate("Dialog", "删除成功"))
        self.label_true_count.setText(_translate("Dialog", "0"))
        self.label_4.setText(_translate("Dialog", "删除失败"))
        self.label_false_count.setText(_translate("Dialog", "0"))
        self.label_3.setText(_translate("Dialog", "删除成功"))
        self.label_true_count_2.setText(_translate("Dialog", "0"))
        self.label_5.setText(_translate("Dialog", "删除失败"))
        self.label_false_count_2.setText(_translate("Dialog", "0"))
